 ...
 const featureCards = [
  ...
  if (isDesktop) {
    return (
      <section className="flex flex-col items-center gap-[60px] px-8 py-12 sm:py-20 sm:px-8 px-5 py-[60px] w-full bg-white">
        <Card className="flex flex-col items-start gap-2 p-[60px] sm:p-[60px] pt-8 pb-[60px] px-8 bg-[#12A16B ] rounded-[32px] max-w-[1204px] w-full border-none relative overflow-visible">
  ...
  return (
    <section className="flex flex-col items-center gap-[60px] py-[30px] w-full bg-white">
      <Card className="flex-col items-start gap-2 pt-8 pb-[60px] px-8 bg-[#12A16B] max-w-[1204px] w-full border-none relative overflow-visible">
        <CardContent className="flex flex-wrap items-start gap-[40px] w-full p-0">
