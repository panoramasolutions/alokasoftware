...
export const NavigationBarSection = ({ handleNavClick }: NavigationBarSectionProps) => {
    ...
    <>
      {mainNavItems.map((item, index) => (
        ...
        >
          ...
          >
            <span className="relative w-fit mt-[-1.00px] font-button-base-medium text-[#ffffff] font-bold whitespace-nowrap">
              {item.label}
            </span>
          </NavigationMenuTrigger>
        </NavigationMenuItem>
  ...
  return (
    <header className="flex items-center justify-around gap-[167px] px-8 py-0 relative self-stretch w-full flex-[0_0_auto] z-[2] bg-aloka-gradient p-4">
